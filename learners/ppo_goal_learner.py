...
class PPOGLearner:
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int, goal_manager: GoalManager):
        if goal_manager.vec_goal_shape is None: 
            print("goal space haven't built..............")
            return
        ...
        # get goals from batch
        # shape: (batch_size, episode_length, agent_num, reserved_goal_dim)
        goals = batch["goals"]
        
        i_reward = batch["i_reward"][:, :-1]
        ...
        with th.no_grad():
            ...
            advantages, targets = build_gae_targets(i_reward, 
